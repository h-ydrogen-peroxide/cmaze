...
var ASM_CONSTS = {
  93832: () => { if (document.fullscreenElement) return 1; },  
 93878: () => { return Module.canvas.width; },  
 93910: () => { return parseInt(Module.canvas.style.width); },  
 93958: () => { document.exitFullscreen(); },  
 93985: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 94058: () => { if (document.fullscreenElement) return 1; },  
 94104: () => { return Module.canvas.width; },  
 94136: () => { return screen.width; },  
 94161: () => { document.exitFullscreen(); },  
 94188: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94321: () => { return window.innerWidth; },  
 94347: () => { return window.innerHeight; },  
 94374: () => { if (document.fullscreenElement) return 1; },  
 94420: () => { return Module.canvas.width; },  
 94452: () => { return parseInt(Module.canvas.style.width); },  
 94500: () => { if (document.fullscreenElement) return 1; },  
 94546: () => { return Module.canvas.width; },  
 94578: () => { return screen.width; },  
 94603: () => { return window.innerWidth; },  
 94629: () => { return window.innerHeight; },  
 94656: () => { if (document.fullscreenElement) return 1; },  
 94702: () => { return Module.canvas.width; },  
 94734: () => { return screen.width; },  
 94759: () => { document.exitFullscreen(); },  
 ...
 94939: ($0) => { Module.canvas.style.opacity = $0; },  
 94977: () => { return screen.width; },  
 95002: () => { return screen.height; },  
 95028: () => { return window.screenX; },  
 95055: () => { return window.screenY; },  
 95082: () => { return window.devicePixelRatio; },  
 95118: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95171: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95222: () => { Module.canvas.style.cursor = 'none'; },  
 95259: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95515: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95566: () => { if (document.fullscreenElement) return 1; },  
 95612: () => { return window.innerWidth; },  
 95638: () => { return window.innerHeight; },  
 95665: () => { if (document.pointerLockElement) return 1; }
};
