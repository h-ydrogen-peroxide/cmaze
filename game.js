...
var ASM_CONSTS = {
  93816: () => { if (document.fullscreenElement) return 1; },  
 93862: () => { return Module.canvas.width; },  
 93894: () => { return parseInt(Module.canvas.style.width); },  
 93942: () => { document.exitFullscreen(); },  
 93969: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 94042: () => { if (document.fullscreenElement) return 1; },  
 94088: () => { return Module.canvas.width; },  
 94120: () => { return screen.width; },  
 94145: () => { document.exitFullscreen(); },  
 94172: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94305: () => { return window.innerWidth; },  
 94331: () => { return window.innerHeight; },  
 94358: () => { if (document.fullscreenElement) return 1; },  
 94404: () => { return Module.canvas.width; },  
 94436: () => { return parseInt(Module.canvas.style.width); },  
 94484: () => { if (document.fullscreenElement) return 1; },  
 94530: () => { return Module.canvas.width; },  
 94562: () => { return screen.width; },  
 94587: () => { return window.innerWidth; },  
 94613: () => { return window.innerHeight; },  
 94640: () => { if (document.fullscreenElement) return 1; },  
 94686: () => { return Module.canvas.width; },  
 94718: () => { return screen.width; },  
 94743: () => { document.exitFullscreen(); },  
 94770: () => { if (document.fullscreenElement) return 1; },  
 94816: () => { return Module.canvas.width; },  
 94848: () => { return parseInt(Module.canvas.style.width); },  
 94896: () => { document.exitFullscreen(); },  
 94923: ($0) => { Module.canvas.style.opacity = $0; },  
 94961: () => { return screen.width; },  
 94986: () => { return screen.height; },  
 95012: () => { return window.screenX; },  
 95039: () => { return window.screenY; },  
 95066: () => { return window.devicePixelRatio; },  
 95102: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95155: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95206: () => { Module.canvas.style.cursor = 'none'; },  
 95243: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95499: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95550: () => { if (document.fullscreenElement) return 1; },  
 95596: () => { return window.innerWidth; },  
 95622: () => { return window.innerHeight; },  
 95649: () => { if (document.pointerLockElement) return 1; }
};
